...
# base_dir = r"C:\Users\Admin\Documents\ZEDCodes\data" # Root Directory to Save iPhone Dataset
...
# config = dict(
#     workdir=r"C:\Users\Admin\Documents\SplaTAM\experiments\ZED_test",#f"./{base_dir}/{scene_name}",
...
#         basedir=base_dir,
#         sequence=scene_name,
#         desired_image_height=720,#int(full_res_height//downscale_factor),
#         desired_image_width=1280,#int(full_res_width//downscale_factor),
...
data = dict(
    dataset_name='nerfcapture',
    basedir='C:/Users/Admin/Documents/ZEDCodes/data',
    sequence='',
    desired_image_height=380,
    desired_image_width=520,
    start=0,
    end=-1,
    stride=9,
    num_frames=num_frames  # можно поставить больше, если хочешь
)

workdir = 'C:/Users/Admin/Documents/SplaTAM/experiments/ZED_reconstruction'
run_name = 'SplaTAM_iPhone'
depth_scale = 10.0  # если глубина в мм (png)
